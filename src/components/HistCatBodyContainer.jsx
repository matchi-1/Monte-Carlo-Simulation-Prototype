...
import HistCatBodyContainer from './components/HistCatBodyContainer'; // Import the new component
      ...
      <div className='body'>
        ...
        <div className='monte-carlo-sim-container'>
          <div className='hist-cat-container'>
            ...
            {/* Use the HistCatBodyContainer component */}
            <HistCatBodyContainer activeTab={activeTab} />
          </div>
